    ...
    return (
        <div className="mt-5 mb-10 lg:flex lg:items-center lg:gap-10">
            ...
            <div className="hidden lg:block lg:w-1/2">
                <p className={ `heading-hero font-bold transition-opacity text-center duration-1000 ease-in-out ${activeAccordion ? "opacity-100" : "opacity-0"} lg:text-6xl 2lg:text-7xl 1xl:text-8xl` }>
