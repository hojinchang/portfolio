...
const Nav:FC = () => {
    ...
    return (
        <div className="flex justify-center">
            <nav className={`w-full z-10 ${isMobile ? "fixed w-full bottom-0 px-2 py-4 bg-neutral-900 border-t border-neutral-700 shadow-top-shadow" : "absolute top-0 px-8 pt-6"}`}>
