...
const Nav:FC = () => {
    ...
    return (
        <div className="flex justify-center">
            <nav ref={ navRef } className={ `mx-auto w-content z-10 ${isMobile ? "fixed left-0 right-0 bottom-0 px-2 py-4 bg-neutral-900 border-t border-neutral-700 shadow-top-shadow" : "absolute top-0 px-8 pt-6"}` }>
